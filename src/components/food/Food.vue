            ...
            <ul class="rating-content" v-if="food.rating">
              <li v-for="comment in food.rating.comment_list" class="comment-item">
                <div class="comment-header">
                  <img :src="comment.user_icon" class="icon" v-if="comment.user_icon"/>
                  <img src="./anonymity.png" class="icon" v-if="!comment.user_icon"/>
                </div>
...
<style>
  ...
  .food .food-wrapper .rating-wrapper .rating-content .comment-item{
  ...
  .food .food-wrapper .rating-wrapper .rating-content .comment-item .comment-header {
    flex: 0 0 41px;
    margin-right: 10px;
  }

  .food .food-wrapper .rating-wrapper .rating-content .comment-item .comment-header img {
    width: 41px;
    height: 41px;
    border-radius: 50%; 
  }

  .food .food-wrapper .rating-wrapper .rating-content .comment-item .comment-main {
    flex: 1;
    margin-top: 6px;
  }

  .food .food-wrapper .rating-wrapper .rating-content .comment-item .comment-main .user {
    width: 50%;
    float: left;
    text-align: left;
    font-size: 12px;
  ...
  .food .food-wrapper .rating-wrapper .rating-content .comment-item .comment-main .time {
    width: 50%;
    float: right;
    text-align: right;
    font-size: 10px;
  ...
  .food .food-wrapper .rating-wrapper .rating-content .comment-item .comment-main .content {
    margin-top: 17px;
    font-size: 13px;
    line-height: 19px;
    text-align: left;
