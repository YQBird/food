 <<template>
  <div class="header">
      ...
      <div class="bulletin-wrapper">
        ...
        <div class="detail" v-if="poiInfo.discounts2" @click="toggleBulletin">
...
.header .top-wrapper .more-wrapper .more-bt .c-radius {
  width: 3px;
  height: 3px;
  border-radius: 50%;
  border: 1px solid white;
...
/* Add Transition effect for bulletin */
.fade-enter-active, .detail-leave-active {
  transition: 1s all;
}
